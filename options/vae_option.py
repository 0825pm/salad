...
def arg_parse(is_train=False):
    ...
    parser.add_argument("--kl_anneal_iters", type=int, default=2000,
                        help="linearly ramp KL weight from 0 to lambda_kl over this many iters (0=no annealing)")
    ...
    parser.add_argument("--use_hand_vel", action="store_true", default=True,
                        help="Append hand velocity (133D→223D). Default True for richer graph attention.")
    parser.add_argument("--no_hand_vel", dest="use_hand_vel", action="store_false",
                        help="Disable hand velocity (133D only)")
    ...
    parser.add_argument("--joint_root", type=str, default=None, help="135D joint data root")
